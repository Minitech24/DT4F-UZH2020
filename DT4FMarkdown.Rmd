...
```
>>>>>>> 3656f2cc9f4e3304203f943726a0eedaacb0f1e6
...
# draw the plot
plot(x=date_betas[2:6176], y=P_beta_P1_daily, ylim=c(0.1,2.6),type= "l", lty = 1, lwd = 3, col = "yellow", cex.axis = 1, cex.lab = 1, ylab = "daily betas", xlab = "Time")
...
legend("topleft", c("Portfolio 1", "Portfolio 2", "Portfolio 3", "Portfolio 4", "Portfolio 5"), 
       lty = c(1,3,4,2,1), lwd = 3, bty = "n",cex = 1, col = c("yellow", "blue", "gray","red","black"))
```
...
cumulative_returns_SMI <- cumprod(1+monthly_total_SMIreturns$SMI.Total.Return['1994-04-29/2017-12-29'])

plot(x=datebond_monthly[71:355], y=cumulative_returns_swissbond, ylim=c(0,7),type= "l", lty = 1, lwd = 3, col = "red", cex.axis = 1, cex.lab = 1, ylab = "Cumulative Return", xlab = "Time")
...
```{r}
# draw the plot
plot(x=date_betas[2:6176], y=P_beta_P1_daily, ylim=c(0.1,5),type= "l", lty = 1, lwd = 3, col = "yellow", cex.axis = 1, cex.lab = 1, ylab = "daily betas", xlab = "Time")
lines(date_betas[2:6176], P_beta_P2_daily, lty = 3, lwd = 3, col = "blue")
lines(date_betas[2:6176], P_beta_P3_daily, lty = 4, lwd = 3, col = "gray")
lines(date_betas[2:6176], P_beta_P4_daily, lty = 2, lwd = 3, col = "red")
lines(date_betas[2:6176], P_beta_P5_daily, lty = 1, lwd = 3, col = "black")
...
legend("topleft", c("Portfolio 1", "Portfolio 2", "Portfolio 3", "Portfolio 4", "Portfolio 5","Swiss Bond","SMI ETF"), 
       lty = c(1,3,4,2,1,1,1,1), lwd = 3, bty = "n",cex = 0.9, col = c("yellow", "blue", "gray","red","black","red","green"))
```
```
