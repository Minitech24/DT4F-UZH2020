...
**Average Daily Return of each beta-sorted portfolios**
...
**Standard Deviation of each beta-sorted portfolios**
...
swissbond_monthly <- read.csv("Swissbond_monthly.csv",sep = ";", header = TRUE, dec = '.',fileEncoding="UTF-8-BOM")
...
SMI_monthly <- read.table("SMIMonthly.csv",sep = ";", header = TRUE, na = "NA",fileEncoding="UTF-8-BOM")
